...
- [ ] 1. Kiểm tra danh sách Phản hồi/Chat nhận về từ Supabase (bảng `feedbacks`).
- [ ] 2. Kiểm tra tính năng Polling nhắn tin (Chat Polling):
...
- [ ] 5. Kiểm tra màn hình phát tin tức (Broadcast):
